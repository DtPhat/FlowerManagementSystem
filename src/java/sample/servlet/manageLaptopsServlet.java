 ...
 * @author PHAT
 */
public class manageLaptopsServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            ArrayList<Laptop> laptopList = LaptopDAO.getLaptops();
            ...
            request.getRequestDispatcher("ManageLaptops.jsp").forward(request, response);
        }
    }
